...
Version  : 3.3.551.0
Release  : 59
URL      : https://github.com/aws/amazon-ssm-agent/archive/3.3.551.0/amazon-ssm-agent-3.3.551.0.tar.gz
Source0  : https://github.com/aws/amazon-ssm-agent/archive/3.3.551.0/amazon-ssm-agent-3.3.551.0.tar.gz
...
Patch2: 0002-Avoid-style-checks-for-the-build.patch
...
%prep
%setup -q -n amazon-ssm-agent-3.3.551.0
cd %{_builddir}/amazon-ssm-agent-3.3.551.0
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a amazon-ssm-agent-3.3.551.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719950803
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/dario.cat/mergo/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/eecfc0c7e0930c6ba1ed0ff2d46a0a6fa0d16d6c || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/ProtonMail/go-crypto/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/d6a5f1ecaedd723c325a2063375b3517e808a2b5 || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/cloudflare/circl/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/bad1f93907dee00771bdd5c456190987805bdf12 || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/cyphar/filepath-securejoin/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/8fb92f475d78da1315877a719c6856fc64531d30 || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/golang/groupcache/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/172ca3bbafe312a1cf09cfff26953db2f425c28e || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/google/go-github/v61/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/d80a2259c41a1be1d07366c4df5d2edf3afede27 || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/pjbgf/sha1cd/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/github.com/skeema/knownhosts/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/92170cdc034b2ff819323ff670d3b7266c8bffcd || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/golang.org/x/mod/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/d6a5f1ecaedd723c325a2063375b3517e808a2b5 || :
...
cp %{_builddir}/amazon-ssm-agent-%{version}/vendor/golang.org/x/tools/LICENSE %{buildroot}/usr/share/package-licenses/amazon-ssm-agent/d6a5f1ecaedd723c325a2063375b3517e808a2b5 || :
...
/usr/share/package-licenses/amazon-ssm-agent/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
/usr/share/package-licenses/amazon-ssm-agent/892204393ca075d09c8b1c1d880aba1ae0a2b805
/usr/share/package-licenses/amazon-ssm-agent/8fb92f475d78da1315877a719c6856fc64531d30
...
/usr/share/package-licenses/amazon-ssm-agent/bad1f93907dee00771bdd5c456190987805bdf12
...
/usr/share/package-licenses/amazon-ssm-agent/d80a2259c41a1be1d07366c4df5d2edf3afede27
