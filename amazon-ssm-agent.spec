...
Source0  : https://github.com/aws/amazon-ssm-agent/archive/3.1.1767.0/amazon-ssm-agent-3.1.1767.0.tar.gz
...
%prep
%setup -q -n amazon-ssm-agent-3.1.1767.0
cd %{_builddir}/amazon-ssm-agent-3.1.1767.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663171229
